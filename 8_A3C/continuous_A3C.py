...
class Net(nn.Module):
    ...
    def loss_func(self, s, a, v_t):
        ...
        # critic loss, v_t is the discounted reward
        td = v_t - values
        c_loss = td.pow(2)
        # actor loss: using traditional policy gradient algorithm
        #             loss = -time_difference*log(pi(s,a))
