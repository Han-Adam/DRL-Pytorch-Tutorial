...
MAX_TRAJECTORY_LEN = 10                         # maximum trajectory length
BATCH_SIZE = 32                                 # the number of samples for each train
START_LEARN = 64                                # the step start to learn
...
for episode in range(MAX_EPISODE):
    ...
    while True:
        ...
        # reward reshaping, the smaller theta and closer to center the better
        ...
        ep_r += r
        if agent.memory.total_counter > START_LEARNING:
            # time to learn
            agent.learn()
        ...
        if done:
            ...
            print('episode: ', episode, total_steps,
                  ' ep_r: ', round(ep_r, 2),
